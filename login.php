...
if($user){
  ...
  $ms="Username or Password is invalid!";
}
}
            ...
            <div class="card-body">
              ...
              <!-- <div class="app-brand justify-content-center">
                <a href="index.php" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-heading fw-bold">Reza Fitness</span>
                </a>
              </div> -->
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Reza Fitness Center! 👋</h4>
              <p class="mb-6">Please sign-in to your account and start the adventure</p>
              <div class="error-message text-center" style="color:red;font-size:1.5em;text-align:center;">
                                         <?= $ms; ?>
                                    </div>

              <form id="formAuthentication" class="user mb-6" method="POST"  >
                <div class="mb-6">
                ...
                <div class="mb-6">
                  <button name="btnlogin" class="btn btn-primary d-grid w-100" type="submit">Login</button>
