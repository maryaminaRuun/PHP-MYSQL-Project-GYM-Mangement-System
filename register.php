            ...
            <div class="authentication-inner">
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-1 title">Adventure starts here 🚀</h4>
                        <p class="mb-6">Make your Register</p>

                        <form method="post" id="formAuthentication" class="mb-6" action="users.php">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="mb-6">
                                    ...
                                    <span class="error-message text-danger" id="RoleError"></span>
                                </div>
                                <div class="mb-6">
                                ...
                                <button  type="submit" class="btn btn-primary d-grid w-100" name="btnSignup">Sign up</button>
                        </form>
