<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        ...
        <a href="index.php" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-semibold ms-2">Reza GYM</span> -->
              <div style="display: flex; align-items: center;">
    <span class="app-brand-logo demo me-1">
        <i class="bx bx-dumbbell" style="font-size: 50px; color: var(--bs-primary);"></i>
    </span>
    <span class="app-brand-text demo menu-text fw-semibold ms-2">Reza GYM</span>
</div>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item ">
            <a href="members.php" class="menu-link menu-toggle">
                
                <i class="menu-icon tf-icons bx bx-group"></i>

                <div class="text-truncate" data-i18n="Account Settings">Members</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item list-unstyled list-unstyled">
                    <a href="members.php" class="menu-link">
                        <div class="text-truncate" data-i18n="Account">All Members</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="memberShip.php" class="menu-link">
                        <div class="text-truncate" data-i18n="Notifications">MemberShips</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="schedule.php" class="menu-link">
                    <!-- <i class="menu-icon tf-icons bx bx-time"></i> -->
                        <div class="text-truncate" data-i18n="Connections">Schedule</div>
                    </a>
                </li>
            </ul>
        ...
        <li class="menu-item">
            <a href="trainer.php" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-run" style="font-size: 27px;"></i>
                <div class="text-truncate" data-i18n="Account Settings">Trainers</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="trainer.php" class="menu-link">
                        <div class="text-truncate" data-i18n="Account">All Trainers</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="class.php" class="menu-link">
                        <div class="text-truncate" data-i18n="Notifications">Class</div>
                    </a>
                </li>
        ...
        <li class="menu-item ">
            <a href="equipment.php" class="menu-link menu-toggle">
            <i class="menu-icon tf-icons bx bx-dumbbell"></i>

                <div class="text-truncate" data-i18n="Account Settings">Equipments</div>
            </a>
            <ul class="menu-sub">
            <li class="menu-item">
            <a href="equipment.php" class="menu-link ">
                <div class="text-truncate" data-i18n="Account Settings">Equipment</div>
            </a>
        </li>
            </ul>
        </li>
        ...
        <li class="menu-item ">
            <a href="charges.php" class="menu-link menu-toggle">
            
            <i class="menu-icon tf-icons bx bx-dollar" style="font-size: 27px;"></i>


                <div class="text-truncate" data-i18n="Account Settings">Payment</div>
            </a>
            <ul class="menu-sub">
            <li class="menu-item">
            <a href="charges.php" class="menu-link ">
                <div class="text-truncate" data-i18n="Account Settings">charge</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="charge-income.php" class="menu-link ">
                <div class="text-truncate" data-i18n="Account Settings">Income</div>
            </a>
        </li>

        <li class="menu-item">
            <a href="bank.php" class="menu-link ">
                <div class="text-truncate" data-i18n="Account Settings">Bank</div>
            </a>
        </li>
            </ul>
        </li>
        ...
        <!-- <li class="menu-item">
            ...
            <i class="menu-icon tf-icons bx bx-file"></i>
                <div class="text-truncate" data-i18n="Authentications">Reports</div>
            </a>
            <ul class="menu-sub">
               
                <li class="menu-item">
                    <a href="AllRepots.php" class="menu-link" ">
                        <div class="text-truncate" data-i18n="Basic">All Reports</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="DailyRepot.php" class="menu-link" ">
